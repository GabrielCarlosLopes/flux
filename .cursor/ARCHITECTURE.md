...
### Flux Flutter Pipeline (5) — **use for all `lib/` feature work**

| Agent                           | Focus                         | Pipeline step |
| ------------------------------- | ----------------------------- | ------------- |
| `flutter-pipeline-orchestrator` | Enforces full pipeline flow   | Conductor     |
| `flutter-task-writer`           | Technical tasks, no code      | 1             |
| `flutter-implementation`        | MVVM implementation           | 2             |
| `flutter-code-review`           | APPROVED / CHANGES_REQUIRED   | 3             |
| `flutter-qa-test`               | analyze + tests PASSED/FAILED | 4             |

Workflow: `/flux <request>` · Docs: `docs/FLUTTER_PIPELINE.md` · Skill: `flutter-pipeline`
...
| `flutter-pipeline`| Flux MVVM multi-agent pipeline (task→QA)         |
...
| `/flux`          | Flux Flutter pipeline (task→implement→review→QA) |
...
| Metric              | Value                             |
| ------------------- | --------------------------------- |
| **Total Agents**    | 25 (+5 Flux pipeline)             |
| **Total Skills**    | 46 (+ flutter-pipeline)           |
| **Total Workflows** | 15 (+ /flux)                      |
...
| Flux app | `flutter-pipeline-orchestrator` | flutter-pipeline            |
